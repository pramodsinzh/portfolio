        ...
        >
            ...
            <div className="mt-10 relative w-full">
                <AnimatePresence mode="wait">
                    ...
                    >
                        <img src={testimonials[curSlide].image} alt={testimonials[curSlide].name} className="size-20 rounded-full object-cover" />

                        <div className="flex-1 space-y-4">
                            <div>
                                <h3 className="text-lg font-semibold text-white">{testimonials[curSlide].name}</h3>

                                <p className="text-sm text-neutral-400">{testimonials[curSlide].role}</p>
                            </div>
